...
public class MetroMapDrawer {
    ...
    public MetroMapDrawer(@NotNull MetroMap map, double margin, double scaleFactor) {
        this.map = map;
        this.margin = margin;
    ...
    public void draw(@NotNull GraphicsContext context, @NotNull Envelope bbox) {
        ...
        context.translate(-bbox.getMinX() * scaleFactor + margin, -bbox.getMinY() * scaleFactor + margin);
        ...
        map.getNodes().stream()
                ...
                .forEach(node -> {
                    ...
                    context.fillRoundRect((station.getMinX() - 5) * scaleFactor, (station.getMinY() - 5) * scaleFactor, (station.getWidth() + 10) * scaleFactor, (station.getHeight() + 10) * scaleFactor, 25 * scaleFactor, 25 * scaleFactor);
                    context.setFill(Color.WHITE);
                    context.fillRoundRect(station.getMinX() * scaleFactor, station.getMinY() * scaleFactor, station.getWidth() * scaleFactor, station.getHeight() * scaleFactor, 25 * scaleFactor, 25 * scaleFactor);
                });
