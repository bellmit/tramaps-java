...
public class MetroMapEdgeAdjNode extends MetroMap {

    public MetroMapEdgeAdjNode() {

        super(1, 50, 25);

        Route line1 = new Route("U1", 50, Color.BLUE);
        Route line2 = new Route("U2", 50, Color.RED);
        Route line3 = new Route("U3", 20, Color.GREEN);
        Route line4 = new Route("U4", 50, Color.YELLOW);

        Function<Node, NodeSignature> signatureFunction = SquareStationSignature::new;

        Node a = createNode(10, 10, "A", signatureFunction);
        Node b = createNode(50, 10, "B", signatureFunction);
        Node c = createNode(60, 60, "C", signatureFunction);
